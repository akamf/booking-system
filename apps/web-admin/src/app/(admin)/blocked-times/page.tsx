  ...
  return (
    <div className="space-y-8">
      <header>
        ...
        <h1 className="page-title">Blocked times</h1>
        <p className="page-description">
          Reserve maintenance, holidays, and closures so public booking stays
          accurate.
        </p>
      </header>

      <form action={addBlockedTime} className="surface max-w-3xl space-y-4 p-6">
            ...
            <tbody className="divide-y divide-neutral-200">
              {blocks.map((b) => (
                <tr key={b.id} className="table-row">
                  ...
                  <td className="px-4 py-3 text-sm">
                    <form
                      action={deleteBlockedTime.bind(null, b.id)}
                      className="inline"
                    >
                      <button
                        type="submit"
